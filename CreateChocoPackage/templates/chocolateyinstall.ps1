...
$fileLocation = Join-Path $toolsDir 'DeveAppMaximizer.7z'
...
#   softwareName  = 'DeveAppMaximizer*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
